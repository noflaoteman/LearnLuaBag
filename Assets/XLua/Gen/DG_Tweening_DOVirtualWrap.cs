...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOVirtualWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Vector2", _m_Vector2_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Vector2_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.TweenCallback<UnityEngine.Vector2> _onVirtualUpdate = translator.GetDelegate<DG.Tweening.TweenCallback<UnityEngine.Vector2>>(L, 4);
                    
                        var gen_ret = DG.Tweening.DOVirtual.Vector2( _from, _to, _duration, _onVirtualUpdate );
                        translator.Push(L, gen_ret);
